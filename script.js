...
function registerSW(){
  ...
  navigator.serviceWorker.register('/DesafioHV8/service-worker.js').then(reg=>{
...
async function setupSocialFeatures() {
  ...
  unsubFriendRequests = listenFriendRequests(currentUser.uid, (reqs) => {
    friendRequestsCache = reqs;
